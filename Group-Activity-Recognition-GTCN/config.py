...
class Config(object):
    ...
    def __init__(self, dataset_name):
        ...
        # Dataset
        assert(dataset_name in ['volleyball', 'collective', 'volleytatic'])
        self.dataset_name=dataset_name 
        
        if dataset_name=='volleyball':
            self.data_path='/home/kong/mydisk/volleyball2016/volleyball'  #data path for the volleyball dataset
            ...
            # self.train_seqs = [0,1]  #video id list of train set
            # self.test_seqs = [2,3]  #video id list of test set

        elif dataset_name == 'volleytatic':
            self.data_path = '/home/kong/mydisk/taticDataset/volleyballtatic'
            self.det_path = '/home/kong/mydisk/taticDataset/volleyballtatic_det'
    ...
    def init_config(self, need_new_folder=True):
        ...
        self.result_path='/home/kong/multi-track-code/Group-Activity-Recognition-GTCN/result/%s'%self.exp_name
        self.log_path='/home/kong/multi-track-code/Group-Activity-Recognition-GTCN/result/%s/log.txt'%self.exp_name
